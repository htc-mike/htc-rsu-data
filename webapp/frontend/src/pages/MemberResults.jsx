...
import { Search, Filter, Calendar, Trophy, Users, MapPin, Ruler } from 'lucide-react'
...
function MemberResults() {
  ...
  const filteredResults = results.filter(result => {
    ...
    return matchesSearch && matchesEvent && matchesRace && matchesLocation && matchesDistance
  })
              ...
              <div key={eventKey} className="card overflow-hidden">
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[#94A3B8]">{isEventExpanded ? '▼' : '▶'}</span>
                  </div>
                </div>
                        ...
                        <div key={raceKey}>
                          ...
                          >
                            <div className="flex items-center justify-between">
                              ...
                              <span className="text-[#94A3B8]">{isRaceExpanded ? '▼' : '▶'}</span>
                            </div>
                          </div>
